...
app.engine('handlebars', exphbs({
  ...
  runtimeOptions: {
    ...
    allowedProtoProperties: {
      _id: true,    // Allow access to the "_id" property
      title: true,  // Allow access to the "title" property
      dueDate: true,// Allow access to the "dueDate" property
      details: true // Allow access to the "details" property
...
app.get('/', (req, res) => {
  const title = 'Welcome to ToDoList!';
  res.render('index', {
    title: title
  });
});
